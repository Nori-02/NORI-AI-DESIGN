...
const ImageUploader: React.FC<ImageUploaderProps> = ({ title, description, onImageChange }) => {
    ...
    return (
        <div>
            ...
            <div
                className="relative border-2 border-dashed border-gray-700 rounded-xl p-4 text-center cursor-pointer hover:border-purple-500 hover:bg-purple-500/5 transition-colors duration-300 group focus:outline-none focus:ring-2 focus:ring-purple-500"
                ...
                {preview ? (
                    <>
                        ...
                        <button
                            ...
                            className="absolute top-2 right-2 bg-red-600/80 text-white rounded-full p-1.5 hover:bg-red-500 transition-all scale-90 opacity-80 group-hover:scale-100 group-hover:opacity-100"
                    ...
                    <div className="py-4">
                        <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-12 w-12 text-gray-600 group-hover:text-purple-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M7 16a4 4 0 01-4-4V7a4 4 0 014-4h10a4 4 0 014 4v5a4 4 0 01-4 4H7z" /></svg>
                        <p className="mt-2 font-medium text-gray-400">Click to upload or paste</p>
